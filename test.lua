...
-- (überarbeitet – queue_on_teleport wie in Infinite Yield)
-- ============================================================
...
-- 🔥 Executor‑übergreifende queue_on_teleport (wie in IY)
...
-- Den gesamten Code als String speichern (für den Neustart)
local scriptCode = [=[
...
-- queue_on_teleport auch im inneren Code definieren
local queueteleport = queue_on_teleport or
                     (syn and syn.queue_on_teleport) or
                     (fluxus and fluxus.queue_on_teleport)
...
local function hopToAnotherServer()
    ...
    -- 🔥 Auto‑Restart registrieren – einheitlich mit String (wie in IY)
...
-- (optional) für andere Executoren als Synapse bereitstellen
_G.__scriptCode = scriptCode

-- Starte den äußeren Code
