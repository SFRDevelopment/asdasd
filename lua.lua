...
-- =============================================================
-- WICHTIG: RAW_URL auf deinen eigenen GitHub-Raw-Link setzen!
local RAW_URL = "https://raw.githubusercontent.com/SFRDevelopment/asdasd/refs/heads/main/eee.lua"
-- =============================================================
...
-- queue_on_teleport robust auflösen (Executor-unabhängig)
...
local function hopToAnotherServer()
    ...
    -- Auto-Restart: GitHub-Loader für den nächsten Server einreihen
